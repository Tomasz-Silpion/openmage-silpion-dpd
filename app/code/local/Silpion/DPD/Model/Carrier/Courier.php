...
class Silpion_DPD_Model_Carrier_Courier extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface
{
    protected $_code = 'dpd_courier';
